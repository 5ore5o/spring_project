...
<div class="subpage_view3">
    <ul class="pageing">
        ...
        <img src="./ico/double_left.svg" style="width: 20px; height: 20px;">
        </a>
        </li>
        ...
        <cr:forEach var="i" begin="${startPage}" end="${endPage}">
            <li>
        ...
        <cr:if test="${currentPage >= totalPages}">style="pointer-events: none; opacity:0.5;"</cr:if>>
        <img src="./ico/double_right.svg" style="width: 20px; height: 20px;">
        </a>
        </li>
    </ul>
</div>
