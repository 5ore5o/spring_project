    ...
    <section class="admin_bgcolor_add">
        <div class="admin_login_add">
            ...
            <ul>
                ...
                <li>
                    <input type="text" class="add_input1" placeholder="접속할 패스워드를 입력하세요" name="adpw">
                    <input type="text" class="add_input1" placeholder="동일한 패스워드를 입력하세요" id="adpwck">
                </li>
                ...
                <input type="text" class="add_input1 hp1" placeholder="HP" value="010" maxlength="3" name="adnum">
                -
                <input type="text" class="add_input1 hp2" placeholder="1234" maxlength="4" name="adnum">
                -
                <input type="text" class="add_input1 hp2" placeholder="5678" maxlength="4" name="adnum">
                </li>
            ...
            <span class="admin_addbtn">
                <button type="button" class="btn_button btncolor1" title="관리자 등록" onclick="adsign_up()">관리자 등록</button>
...
<script>
function adsign_up(){
	var adpwck=document.getElementById("adpwck").value;
	if(adminfrm2.adid.value==""||adminfrm2.adname.value=="")
