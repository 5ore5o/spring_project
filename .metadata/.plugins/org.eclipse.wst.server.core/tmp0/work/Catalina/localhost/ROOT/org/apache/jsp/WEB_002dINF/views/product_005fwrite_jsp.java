 ...
 * Generated at: 2024-08-20 07:21:27 UTC
...
public final class product_005fwrite_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  static {
    ...
    _jspx_dependants.put("/WEB-INF/views/./code/pr_wr.jsp", Long.valueOf(1724137301698L));
...
request.setAttribute("pd_code", pd_code);
      ...
      out.write("        <li>\r\n");
      out.write("            <select class=\"product_input1\" name=\"pd_lname\">\r\n");
      out.write("            ");
      ...
      out.write("        <li>\r\n");
      out.write("            <input type=\"text\" class=\"product_input1\" name=\"pd_code\" value=\"");
      out.print(pd_code);
      out.write("\" readonly>\r\n");
      ...
      out.write("        <li>\r\n");
      out.write("            <input type=\"text\" class=\"product_input3\" maxlength=\"7\" name=\"pd_cash\" id=\"pd_cash\"> <span class=\"help_text\">※ , 없이 숫자만 입력하세요 최대 7자리</span>\r\n");
      out.write("        </li>\r\n");
      out.write("    </ul>\r\n");
      out.write("    <ul>\r\n");
      out.write("        <li>할인율</li>\r\n");
      out.write("        <li>\r\n");
      out.write("            <input type=\"text\" class=\"product_input3\" maxlength=\"2\" value=\"0\" name=\"pd_dcr\" id=\"pd_dcr\">% <span class=\"help_text\">※ 숫자만 입력하세요</span>\r\n");
      out.write("        </li>\r\n");
      out.write("    </ul>\r\n");
      out.write("    <ul>\r\n");
      out.write("        <li>할인가격</li>\r\n");
      out.write("        <li>\r\n");
      out.write("            <input type=\"text\" class=\"product_input3\" maxlength=\"7\" value=\"0\" name=\"pd_dcp\" id=\"pd_dcp\" readonly> <span class=\"help_text\">※ 할인율이 0%일 경우 할인가격은 0으로 처리 합니다.</span>\r\n");
      out.write("        </li>\r\n");
      out.write("    </ul>\r\n");
      out.write("    <ul>\r\n");
      ...
      out.write("    <input type=\"button\" value=\"상품 리스트\" title=\"상품 리스트\" class=\"p_button p_button_color1\" style=\"margin-right: 5px;\" id=\"backlist\">\r\n");
      out.write("    <input type=\"button\" value=\"상품 등록\" title=\"상품 등록\" class=\"p_button p_button_color2\" id=\"prin\">\r\n");
      out.write("</div>\r\n");
      out.write("</section>\r\n");
      out.write("</main>\r\n");
      out.write("<script type=\"module\">\r\n");
      out.write("import {pdset}from \"./js/pd_ca.js?v=1\";\r\n");
      out.write("\r\n");
      out.write("document.querySelector(\"#pdcate\").addEventListener(\"click\",function(){\r\n");
      out.write("new pdset().pdcate();\r\n");
      out.write("});\r\n");
      out.write("document.querySelector(\"#backlist\").addEventListener(\"click\",function(){\r\n");
      out.write("new pdset().back();\r\n");
      out.write("});\r\n");
      out.write("document.querySelector(\"#prin\").addEventListener(\"click\",function(){\r\n");
      out.write("new pdset().productin();\r\n");
      out.write("});\r\n");
      out.write("\r\n");
      out.write("const calDcPrice=()=>{\r\n");
      out.write("const pd_cash= parseInt(document.getElementById(\"pd_cash\").value);\r\n");
      out.write("const pd_dcr= parseInt(document.getElementById(\"pd_dcr\").value);\r\n");
      out.write("\r\n");
      out.write("const pd_dcp= document.getElementById(\"pd_dcp\");\r\n");
      out.write("\r\n");
      out.write("if(pd_dcr==0){\r\n");
      out.write("pd_dcp.value=0;\r\n");
      out.write("}else{\r\n");
      out.write("let cal_dcp= pd_cash-(pd_cash*(pd_dcr/100));\r\n");
      out.write("\r\n");
      out.write("if(cal_dcp % 1 == 0.5){\r\n");
      out.write("cal_dcp=Math.floor(cal_dcp);\r\n");
      out.write("}else{\r\n");
      out.write("cal_dcp=Math.round(cal_dcp);\r\n");
      out.write("}\r\n");
      out.write("\r\n");
      out.write("pd_dcp.value=cal_dcp;\r\n");
      out.write("\r\n");
      out.write("}\r\n");
      out.write("};\r\n");
      out.write("\r\n");
      out.write("document.getElementById(\"pd_cash\").addEventListener(\"input\", calDcPrice);\r\n");
      out.write("document.getElementById(\"pd_dcr\").addEventListener(\"input\",calDcPrice);\r\n");
      out.write("\r\n");
      out.write("</script>");
      out.write("\r\n");
      out.write("<!-- 중단 끝 -->\r\n");
  ...
  private boolean _jspx_meth_cr_005fforEach_005f0(javax.servlet.jsp.PageContext _jspx_page_context)
    ...
    try {
      ...
      // /WEB-INF/views/./code/pr_wr.jsp(26,12) name = var type = java.lang.String reqTime = false required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
      _jspx_th_cr_005fforEach_005f0.setVar("lnameli");
      // /WEB-INF/views/./code/pr_wr.jsp(26,12) name = items type = javax.el.ValueExpression reqTime = true required = false fragment = false deferredValue = true expectedTypeName = java.lang.Object deferredMethod = false methodSignature = null
      _jspx_th_cr_005fforEach_005f0.setItems(new org.apache.jasper.el.JspValueExpression("/WEB-INF/views/./code/pr_wr.jsp(26,12) '${lnameli}'",_jsp_getExpressionFactory().createValueExpression(_jspx_page_context.getELContext(),"${lnameli}",java.lang.Object.class)).getValue(_jspx_page_context.getELContext()));
